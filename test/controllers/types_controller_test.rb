...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { user_description: @type.user_description, user_type: @type.user_type } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { user_description: @type.user_description, user_type: @type.user_type } }
